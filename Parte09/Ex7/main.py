...
def main():
    ...
    # How to find the points that have horizontal normals?
    # We use the angle between the normal of the point and the horizontal direction
    ...
    for idx, normal in enumerate(point_cloud.normals):
        ...
        if abs(angle - 90) < angle_tolerance: # this point has a "horizontal normal"
    ...
    horizontal_cloud.paint_uniform_color([0.5, 0, 1]) # paints the plane in X color

    # ------------------------------------------
    # Visualization
    # ------------------------------------------
    # Create a list of entities to draw
    entities = [horizontal_cloud, non_horizontal_cloud]
